        ...
        {timelineData.map((item, index) => (
          ...
          >
            ...
            <div style={{ 
              ...
              <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: '2rem', margin: 0, color: '#fff', textTransform: 'capitalize', letterSpacing: '1px' }}>
                {item.title}
              </h3>
              <h4 style={{ margin: 0, fontFamily: "'Playfair Display', serif", fontSize: '1.2rem', fontWeight: 500, color: '#e0e0e0', letterSpacing: '0.5px' }}>
                {item.subtitle}
              </h4>
