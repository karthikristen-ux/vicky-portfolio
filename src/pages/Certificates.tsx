  ...
  return (
    <div className="tva-container">
      ...
      >
        ...
        <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(1rem, 1.5vw, 1.2rem)', marginBottom: '3rem', color: '#ccc' }}>
          ...
          {certificates.map((cert, index) => (
            ...
            >
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <span style={{ color: 'var(--tva-orange)', opacity: 0.7, fontFamily: "'Playfair Display', serif", fontSize: '0.9rem' }}>[{cert.date}]</span>
